...
namespace DVLD_Business
{
    public class clsTestAppointment
    {
        ...
        public clsTestType.enTestTypes TestTypeID { set; get; }
        ...
        public clsTestAppointment(int TestAppointmentID, clsTestType.enTestTypes TestTypeID,
        ...
        public static clsTestAppointment GetLastTestAppointment(int LocalDrivingLicenseApplicationID, clsTestType.enTestTypes TestTypeID)
        {
        ...
        public DataTable GetApplicationTestAppointmentsPerTestType(clsTestType.enTestTypes TestTypeID)
        {
        ...
        public static DataTable GetApplicationTestAppointmentsPerTestType(int LocalDrivingLicenseApplicationID, clsTestType.enTestTypes TestTypeID)
        {
